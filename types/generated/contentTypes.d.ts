...
export interface ApiContactFormSubmissionContactFormSubmission
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<['seen', 'ignored', 'contacted']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiFaviconFavicon extends Schema.SingleType {
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    aboutMeText: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    aboutMeDescription: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    servicesText: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    servicesList: Attribute.Component<'shared.text', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    latestPostsText: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    recent_posts: Attribute.Relation<
      'api::global.global',
      'oneToMany',
      'api::post.post'
    >;
    subcribeText: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    recentPosts: Attribute.Component<'shared.recent-posts'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    copyRights: Attribute.Blocks &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
